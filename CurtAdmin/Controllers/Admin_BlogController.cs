...
{
    public class Admin_BlogController : AdminBaseController
    {
        //
        // GET: /Blog/
        ...
        public ActionResult Save(List<string> categories, int id = 0, int userid = 0, bool publish = false, string title = "", int contentID = 0, string content = "", string meta_title = "", string meta_description = "", string keywords = "") {
            try {
                ...
                return RedirectToAction("Index", "Admin_Blog");
            } catch (Exception e) {
                ...
                if (id == 0) {
                    return RedirectToAction("Add", "Admin_Blog", new { err = e.Message });
                } else {
                    return RedirectToAction("Edit", "Admin_Blog", new { id = id, err = e.Message });
                }
            }
        }
